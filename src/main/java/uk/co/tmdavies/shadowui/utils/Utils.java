package uk.co.tmdavies.shadowui.utils;
...
public class Utils {
	...
	public static void setPlayerListHeader(Player player) {

		List<String> tempHeader = ShadowUI.config.getConfig().getStringList("TabList.Header");
		List<String> tempFooter = ShadowUI.config.getConfig().getStringList("TabList.Footer");

		List<String> header = new ArrayList<>();
		List<String> footer = new ArrayList<>();

		tempHeader.forEach(s -> header.add(Utils.Chat(s) + "&r\n"));

		tempFooter.forEach(s -> footer.add(Utils.Chat(s) + "&r\n"));
		...
		if (ShadowUI.papiEnabled) {

			header.forEach(s -> hBuilder.append(PlaceholderAPI.setPlaceholders(player, s)));
			footer.forEach(s -> fBuilder.append(PlaceholderAPI.setPlaceholders(player, s)));

		}

		IChatBaseComponent top = IChatBaseComponent.a(hBuilder.toString());
		IChatBaseComponent bot = IChatBaseComponent.a(fBuilder.toString());

		PacketPlayOutPlayerListHeaderFooter packet = new PacketPlayOutPlayerListHeaderFooter(top, bot);
